----------------------------------------------------
 B5T-007001 サンプルコード（Python3版）
----------------------------------------------------
※はじめに
　このサンプルコードは、Anthony Moriartyさんに提供いただきました。
　彼の協力と尽力に感謝いたします。
　Anthonyさん、ありがとうございました。
...
(2) ファイル説明
  1. ユーザ使用用途
    ...
    hvc_p2_api.py                 B5T-007001 Python APIクラス（結果安定化後）
  ...
  2. 内部クラスなど
    ...
    stb_wrapper.py                64bit STB library 呼び出しラッパクラス
