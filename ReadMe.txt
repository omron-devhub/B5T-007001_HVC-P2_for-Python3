----------------------------------------------------
 B5T-007001 Sample Code （for Python3）
----------------------------------------------------
Regarding the Python 3 Version of the Sample Code

This sample code was provided by Anthony Moriarty.
We extend our heartfelt gratitude for his cooperation and efforts.

Special thank you to Anthony Moriarty.
...
(2) File description
  1. for user use.
    ...
    hvc_p2_api.py                 B5T-007001 Python API class with STB library
...
----
OMRON Corporation 
Copyright 2023-2025 OMRON Corporation, All Rights Reserved.
